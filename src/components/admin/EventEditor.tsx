...
const EventEditor: React.FC<EventEditorProps> = ({ onSave, initialData }) => {
  ...
  return (
    <div className="flex items-start justify-center p-8 min-h-[calc(100vh-48px)] bg-muted">
      <div className="w-full max-w-2xl">
        ...
        <div className="flex justify-center gap-4 mt-8">
          ...
          <button
            ...
            disabled={isSaving || !title}
            className="px-12 py-3 bg-green text-white font-medium rounded-md hover:bg-green/90 transition-colors disabled:opacity-50"
          >
            Publish
          </button>
        </div>
